# -*- coding: utf-8 -*-
"""Bigdata project 2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1AJxpdM36pSZhKSBWTkcFuTc_6vOMRDCz
...
movies_table = dynamodb_client.create_table(TableName='Applemusic',KeySchema=[{'AttributeName': 'collectionId','KeyType': 'HASH'},{'AttributeName': 'artistName','KeyType': 'RANGE'}],AttributeDefinitions=[{'AttributeName': 'collectionId','AttributeType': 'N'},{'AttributeName': 'artistName','AttributeType': 'S'},],ProvisionedThroughput={'ReadCapacityUnits': 10,'WriteCapacityUnits': 10 })
